function [dMdt,dMremin,dMfrag] = interactionsDTseason(t,M,m,xz,bi,bj,nR,nD,q,a,b300,b301,b310,b311,f00,f01,f10,f11,alpha,beta,wWhites,L,H,prod,remin,pfrag,frag_div)
...
dMdt = dM + prod(:)*(1-cos(2*pi*t/365))/2 - M.*wWhites(:)./H +dMremin + dMfrag;
